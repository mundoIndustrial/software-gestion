...
class PermissionHelper
{
    ...
    public static function isAdmin(): bool
    {
        return Auth::check() && 
               Auth::user()->role && 
               in_array(Auth::user()->role->name, ['admin', 'lider_produccion', 'supervisor_produccion']);
    }
    ...
    public static function canViewInsumos(): bool
    {
        ...
        return in_array($role, ['admin', 'lider_produccion', 'supervisor_produccion', 'supervisor-admin', 'insumos']);
    }
    ...
    public static function canViewProduccion(): bool
    {
        ...
        $role = Auth::user()->role->name;
        return in_array($role, ['admin', 'lider_produccion', 'supervisor_produccion', 'supervisor-admin', 'supervisor']);
    }
    ...
    public static function canViewAsesores(): bool
    {
        ...
        $role = Auth::user()->role->name;
        return in_array($role, ['admin', 'lider_produccion', 'supervisor_produccion', 'supervisor-admin', 'asesor']);
    }
    ...
    public static function canViewContador(): bool
    {
        ...
        $role = Auth::user()->role->name;
        return in_array($role, ['admin', 'lider_produccion', 'supervisor_produccion', 'supervisor-admin', 'contador']);
    }
    ...
    public static function canViewCotizaciones(): bool
    {
        ...
        $role = Auth::user()->role->name;
        return in_array($role, ['admin', 'lider_produccion', 'supervisor_produccion', 'supervisor-admin']);
    }
}
