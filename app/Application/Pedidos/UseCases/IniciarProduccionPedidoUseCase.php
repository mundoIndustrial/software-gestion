...
/**
 * Use Case: Iniciar Producción
 * 
 * Transiciona un pedido de CONFIRMADO a EN_PRODUCCION
 */
class IniciarProduccionPedidoUseCase
{
    ...
    public function ejecutar(int $pedidoId): PedidoResponseDTO
    {
        ...
        return new PedidoResponseDTO(
            ...
            mensaje: 'Producción iniciada exitosamente'
        );
    }
}
