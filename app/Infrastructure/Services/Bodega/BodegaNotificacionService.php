...
class BodegaNotificacionService implements BodegaNotificacionServiceContract
{
    /**
    ...
    public function call(string $method, array $arguments = []): mixed
    {
        if (!method_exists($this, $method)) {
            throw new \BadMethodCallException("Method {BodegaNotificacionService}::$method does not exist");
        }
