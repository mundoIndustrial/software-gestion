...
class BodegaAuditoriaService implements BodegaAuditoriaServiceContract
{
    ...
    public function call(string $method, array $arguments = []): mixed
    {
        if (!method_exists($this, $method)) {
            throw new \BadMethodCallException("Method {BodegaAuditoriaService}::$method does not exist");
        }
