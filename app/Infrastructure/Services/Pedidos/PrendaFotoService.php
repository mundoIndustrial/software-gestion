...
class PrendaFotoService
{
    ...
    /**
     * Guardar imagen original con nombre año
     * 
     * @param UploadedFile $archivo
    ...
    private function guardarOriginal(UploadedFile $archivo, ?int $pedidoId = null): string
    {
        ...
        // Guardar en carpeta especifica del pedido si existe
        if ($pedidoId) {
    ...
    private function convertirAWebp(string $rutaOriginal): string
    {
        try {
            ...
            // Si falla la conversion, retornar ruta original como fallback
            return $rutaOriginal;
        }
    }
    ...
    /**
     * Generar nombre año para archivo
     * 
