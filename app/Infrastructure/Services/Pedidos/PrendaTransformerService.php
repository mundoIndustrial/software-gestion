 ...
 */
final class PrendaTransformerService implements PrendaTransformerServiceContract
{
    /**
    ...
    public function call(string $method, array $arguments = []): mixed
    {
        if (!method_exists($this, $method)) {
            throw new \BadMethodCallException("Method {PrendaTransformerService}::$method does not exist");
        }
