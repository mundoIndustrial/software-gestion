...
final class CotizacionController extends Controller
{
    ...
    private function sincronizarPrendasCotizacion(\App\Models\Cotizacion $cotizacion, array $prendasRecibidas): void
    {
        ...
        foreach ($prendasRecibidas as $index => $prendaData) {
            ...
            if (!$prendaModel) {
                $prendaModel = \App\Models\PrendaCot::create([
        ...
        $prendasAEliminar = \App\Models\PrendaCot::where('cotizacion_id', $cotizacion->id)
    ...
    private function sincronizarTallasPrenda(\App\Models\PrendaCot $prenda, array $prendaData): void
    {
    ...
    private function sincronizarVarianteYTelasPrenda(\App\Models\PrendaCot $prenda, array $prendaData): void
    {
        $variantes = $prendaData['variantes'] ?? [];
        if (is_string($variantes)) {
            $variantes = json_decode($variantes, true) ?? [];
        ...
        $variante = \App\Models\PrendaVarianteCot::updateOrCreate(
        ...
        foreach ($telasMultiples as $telaInfo) {
            ...
            \App\Models\PrendaTelaCot::firstOrCreate([
                'prenda_cot_id' => $prenda->id,
        ...
        $telasExistentes = \App\Models\PrendaTelaCot::where('prenda_cot_id', $prenda->id)
    ...
    public function update(Request $request, int $id): JsonResponse
    {
        try {
            ...
            if (is_array($prendasRecibidas)) {
                $this->sincronizarPrendasCotizacion($cotizacion, $prendasRecibidas);
            }
