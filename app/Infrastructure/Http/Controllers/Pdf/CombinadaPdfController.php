...
use App\Application\Services\Pdf\GenerateCombinadaPdfService;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

final class CombinadaPdfController extends Controller
{
    public function __construct(
        private readonly GenerateCombinadaPdfService $generateCombinadaPdfService
    ) {
    }
    ...
    public function generate(int $id, Request $request)
    {
        try {
            ...
            $result = $this->generateCombinadaPdfService->generate($id, $scale, $request->user());
