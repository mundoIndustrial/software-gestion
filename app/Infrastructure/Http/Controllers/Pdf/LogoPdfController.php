...
use App\Application\Services\Pdf\GenerateLogoPdfService;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

final class LogoPdfController extends Controller
{
    public function __construct(
        private readonly GenerateLogoPdfService $generateLogoPdfService
    ) {
    }
    ...
    public function generate(int $id, Request $request)
    {
        try {
            ...
            $result = $this->generateLogoPdfService->generate($id, $scale, $request->user());
