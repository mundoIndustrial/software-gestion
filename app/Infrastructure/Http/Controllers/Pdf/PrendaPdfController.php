...
use App\Application\Services\Pdf\GeneratePrendaPdfService;
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;

final class PrendaPdfController extends Controller
{
    public function __construct(
        private readonly GeneratePrendaPdfService $generatePrendaPdfService
    ) {
    }
    ...
    public function generate(int $id, Request $request)
    {
        try {
            ...
            $result = $this->generatePrendaPdfService->generate($id, $scale, $request->user());
