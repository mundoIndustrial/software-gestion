 ...
 * 
 * Raíz de agregado para Pedido de Producción
 * Encapsula:
 ...
 * que tratamos como una unidad de cambio. PedidoProduccion es la raíz.
 */
class PedidoProduccionAggregate
{
     ...
     * Invariante: estados válidos según negocio
     */
    ...
    /**
     * Registrar un evento en el agregado (pero no publicarlo aún)
