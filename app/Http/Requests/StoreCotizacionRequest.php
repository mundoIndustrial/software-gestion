...
class StoreCotizacionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'productos.*.fotos.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:5120',
            'productos.*.fotos_base64' => 'nullable|array',
            'productos.*.fotos_base64.*' => 'nullable|string',
            'productos.*.telas' => 'nullable|array',
            'productos.*.telas.*' => 'nullable|image|mimes:jpeg,png,jpg,gif,webp|max:5120',
            'productos.*.telas_base64' => 'nullable|array',
            'productos.*.telas_base64.*' => 'nullable|string',
            ...
            'productos.*.variantes.referencia' => 'nullable|string|max:100',
            ...
            'productos.*.variantes.aplica_manga' => 'nullable|boolean|integer',
            'productos.*.variantes.tiene_bolsillos' => 'nullable|boolean|integer',
            'productos.*.variantes.aplica_bolsillos' => 'nullable|boolean|integer',
            'productos.*.variantes.aplica_broche' => 'nullable|boolean|integer',
            'productos.*.variantes.aplica_reflectivo' => 'nullable|boolean|integer',
