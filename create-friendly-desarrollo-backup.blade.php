    ...
    <form id="formCrearPedidoFriendly" class="friendly-form">
        ...
        <div class="form-step active" data-step="1">
            <div class="step-header">
                <h2>PASO 1: INFORMACI├ôN DEL CLIENTE</h2>
                <p>CU├ëNTANOS QUI├ëN ES TU CLIENTE</p>
            </div>
            ...
            <div class="form-section">
                <div class="form-group-large">
                    ...
                    <input type="text" id="cliente" name="cliente" class="input-large" placeholder="EJ: JUAN GARC├ìA, EMPRESA ABC..." value="{{ isset($esEdicion) && $esEdicion && isset($cotizacion) ? $cotizacion->cliente : '' }}" required>
                    ...
                    @if(isset($esEdicion) && $esEdicion && isset($cotizacion) && $cotizacion->productos)
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                console.log('­ƒôª Productos a cargar:', productos);
                                ...
                                productos.forEach((producto, idx) => {
                                    ...
                                    setTimeout(() => {
                                        ...
                                        if (ultimoProducto) {
                                            ...
                                            console.log('Ô£à Producto cargado:', producto.nombre_producto);
                                        }
                                    }, 500);
                                });
                            });
        ...
        <div class="form-step" data-step="3">
            ...
            <div class="form-section">
                <!-- IM├üGENES -->
                <div class="form-group-large">
                    <label for="imagenes_bordado"><i class="fas fa-images"></i> IM├üGENES (M├üXIMO 5)</label>
                    <div id="drop_zone_imagenes" style="border: 2px dashed #3498db; border-radius: 8px; padding: 30px; text-align: center; background: #f0f7ff; cursor: pointer; margin-bottom: 10px;">
                        ...
                        <p style="margin: 10px 0; color: #3498db; font-weight: 600;">ARRASTRA IM├üGENES AQU├ì O HAZ CLIC</p>
                        <p style="margin: 5px 0; color: #666; font-size: 0.9rem;">M├íximo 5 im├ígenes</p>
                ...
                <div style="background: #f9f9f9; border: 2px solid #3498db; border-radius: 8px; padding: 15px; margin-bottom: 20px;">
                    ...
                    <select id="selector_tecnicas" class="input-large" style="width: 100%; margin-bottom: 10px; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                        <option value="">-- SELECCIONA UNA T├ëCNICA --</option>
                ...
                <div style="background: #f9f9f9; border: 2px solid #3498db; border-radius: 8px; padding: 15px; margin-bottom: 20px;">
                    ...
                    <select id="seccion_prenda" class="input-large" style="width: 100%; margin-bottom: 12px; padding: 8px; border: 1px solid #ddd; border-radius: 4px;">
                        <option value="">-- SELECCIONA UNA OPCI├ôN --</option>
        ...
        <div class="form-step" data-step="4">
            <div class="step-header">
                <h2>PASO 4: REVISAR COTIZACI├ôN</h2>
                <p>VERIFICA QUE TODO EST├ë CORRECTO</p>
            </div>

            <div class="form-section">
                <div style="background: #f0f7ff; border-left: 4px solid #3498db; padding: 15px; border-radius: 4px; margin-bottom: 20px;">
                    <p style="margin: 0; color: #333;"><strong>Ô£ô Resumen de tu cotizaci├│n:</strong></p>
    ...
    <div class="producto-card" data-producto-id="">
        <div class="producto-header">
            ...
            <div style="display: flex; gap: 0.5rem;">
                <button type="button" class="btn-toggle-product" onclick="toggleProductoBody(this)" title="Expandir/Contraer" style="font-size: 1.5rem; line-height: 1; font-weight: bold;">Ôû╝</button>
        ...
        <div class="producto-body" style="display: block;">
                ...
                <div class="form-row tipo-prenda-row" style="display: flex; gap: 12px; align-items: flex-start;">
                    <div class="form-col full" style="flex: 1;">
                        ...
                        <div class="prenda-search-container">
                            ...
                            <div class="prenda-suggestions">
                                <div class="prenda-suggestion-item" onclick="seleccionarPrenda('­ƒæö CAMISA', this)">­ƒæö CAMISA</div>
                                <div class="prenda-suggestion-item" onclick="seleccionarPrenda('­ƒæò CAMISETA', this)">­ƒæò CAMISETA</div>
                                <div class="prenda-suggestion-item" onclick="seleccionarPrenda('­ƒÄ¢ POLO', this)">­ƒÄ¢ POLO</div>
                                <div class="prenda-suggestion-item" onclick="seleccionarPrenda('­ƒæû PANTAL├ôN', this)">­ƒæû PANTAL├ôN</div>
                                <div class="prenda-suggestion-item" onclick="seleccionarPrenda('­ƒæù FALDA', this)">­ƒæù FALDA</div>
                                <div class="prenda-suggestion-item" onclick="seleccionarPrenda('­ƒºÑ CHAQUETA', this)">­ƒºÑ CHAQUETA</div>
                                <div class="prenda-suggestion-item" onclick="seleccionarPrenda('­ƒºó SUDADERA', this)">­ƒºó SUDADERA</div>
                                <div class="prenda-suggestion-item" onclick="seleccionarPrenda('ÔØô OTRO', this)">ÔØô OTRO</div>
                            </div>
                        </div>
                        <small class="help-text">PUEDES BUSCAR, SELECCIONAR O ESCRIBIR UNA PRENDA PERSONALIZADA</small>
                    </div>
                    <!-- Selector de Tipo de JEAN/PANTAL├ôN - Oculto por defecto -->
                    <div class="tipo-jean-pantalon-inline" style="display: none; width: 280px; padding: 0; background: transparent; border: none; border-radius: 0; margin-left: 12px; flex-shrink: 0;">
                        <div class="tipo-jean-pantalon-inline-container" style="display: flex; flex-direction: column; gap: 4px;">
                            <!-- El selector se inserta aqu├¡ din├ímicamente -->
                        </div>
                    </div>
                </div>
            </div>

            <!-- SECCI├ôN DE FOTOS DE LA PRENDA -->
            <div class="producto-section">
                <button type="button" class="section-title-btn" onclick="toggleSeccion(this)">
                    <div class="section-title">
                        <i class="fas fa-images"></i> FOTOS DE LA PRENDA (M├üX. 3)
            ...
            <!-- SECCI├ôN DE DESCRIPCI├ôN -->
            <div class="producto-section">
                <div class="section-title"><i class="fas fa-sticky-note"></i> DESCRIPCI├ôN</div>
                <div class="form-row">
                    <div class="form-col full">
                        <label><i class="fas fa-pen"></i> DESCRIPCI├ôN</label>
                        <textarea name="productos_friendly[][descripcion]" class="input-medium" placeholder="DESCRIPCI├ôN DE LA PRENDA..." rows="2"></textarea>
                        <small class="help-text">DESCRIBE LA PRENDA, DETALLES ESPECIALES, LOGO, BORDADO, ESTAMPADO, ETC.</small>
                    </div>
                </div>
            </div>

            <!-- SECCI├ôN DE COLOR, TELA Y REFERENCIA (Tabla con imagen) -->
            <div class="producto-section">
                                    ...
                                    <td style="padding: 12px; text-align: center;">
                                        <label style="display: block; min-height: 60px; padding: 0.5rem; border: 2px dashed #0066cc; border-radius: 6px; cursor: pointer; text-align: center; background: #f0f7ff;" ondrop="manejarDrop(event)" ondragover="event.preventDefault()" ondragleave="this.classList.remove('drag-over')">
                                            ...
                                            <div class="drop-zone-content" style="font-size: 0.7rem;">
                                                ...
                                                <p style="margin: 0.25rem 0; color: #0066cc; font-weight: 500;">ARRASTRA O CLIC</p>
                                                <small style="color: #666;">(M├íx. 3)</small>
                                            </div>
                                        </label>
            ...
            <!-- SECCI├ôN DE VARIACIONES ESPEC├ìFICAS (Tabla HTML) -->
            <div class="producto-section">
                <div class="section-title"><i class="fas fa-sliders-h"></i> VARIACIONES ESPEC├ìFICAS</div>
                <div class="form-row">
                    <div class="form-col full">
                    ...
                    <div class="form-col full">
                        ...
                        <div style="display: flex; gap: 0.75rem; align-items: center; margin-bottom: 1rem; flex-wrap: wrap;">
                            <select class="talla-tipo-select" onchange="actualizarSelectTallas(this)" style="padding: 0.6rem 0.8rem; border: 2px solid #0066cc; border-radius: 6px; font-size: 0.85rem; cursor: pointer; background-color: white; color: #0066cc; font-weight: 600; max-width: 300px;">
                                ...
                                <option value="numero">N├ÜMEROS (DAMA/CABALLERO)</option>
                            </select>
        ...
        <table class="tabla-control-compacta">
            ...
            <tbody>
                ...
                <tbody id="tbody_disponibilidad">
                    ...
                    <tr>
                        <td><label style="margin: 0; font-size: 0.8rem;">F├íbrica</label></td>
                        <td style="text-align: center;">
                            <input type="checkbox" class="checkbox-guardar" style="width: 20px; height: 20px; cursor: pointer; accent-color: #10b981;">
                        </td>
                        <td style="display: flex; gap: 5px;">
