...
class PrendaPedidoEditControllerTest extends TestCase
{
    ...
    {
        $this->assertTrue(
            class_exists(\App\Infrastructure\Http\Controllers\Asesores\PrendaPedidoEditController::class)
        );
    }
    ...
    public function test_controller_has_edit_prenda_method(): void
    {
        $reflection = new \ReflectionClass(
            \App\Infrastructure\Http\Controllers\Asesores\PrendaPedidoEditController::class
        );
