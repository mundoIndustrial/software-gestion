...
class AnalizarPedido45729Seeder extends Seeder
{
    public function run(): void
    {
        ...
        try {
            $pedido = PedidoProduccion::where('numero_pedido', 45729)->first();
            ...
            foreach ($prendas as $prenda) {
                ...
                // Fotos de Telas
                $allColorTelas = PrendaPedidoColorTela::where('prenda_pedido_id', $prenda->id)->pluck('id');
            ...
            foreach ($epps as $epp) {
                ...
                foreach ($fotosEpp as $foto) {
                    echo "         - ID: {$foto->id}\n";
                    echo "         - ruta_original: {$foto->ruta_original}\n";
                    echo "         - ruta_web: {$foto->ruta_web}\n";
                    echo "         - archivo: {$foto->archivo}\n";
                }
            }
