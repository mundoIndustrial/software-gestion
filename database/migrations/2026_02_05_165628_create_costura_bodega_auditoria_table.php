...
return new class extends Migration
{
    ...
    {
        Schema::create('costura_bodega_auditoria', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('costura_bodega_detalle_id');
    ...
    {
        Schema::dropIfExists('costura_bodega_auditoria');
    }
};
