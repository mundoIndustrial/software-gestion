...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::unprepared('
            CREATE TRIGGER before_insert_registro_piso_produccion
            BEFORE INSERT ON registro_piso_produccion
            FOR EACH ROW
            BEGIN
        ...
        DB::unprepared('
            CREATE TRIGGER before_update_registro_piso_produccion
            BEFORE UPDATE ON registro_piso_produccion
            FOR EACH ROW
            BEGIN
                -- Calcular META: (tiempo_disponible / tiempo_ciclo) * 0.9
                IF NEW.tiempo_ciclo IS NOT NULL AND NEW.tiempo_ciclo > 0 AND NEW.tiempo_disponible IS NOT NULL THEN
    ...
    {
        DB::unprepared('DROP TRIGGER IF EXISTS before_insert_registro_piso_produccion');
        DB::unprepared('DROP TRIGGER IF EXISTS before_update_registro_piso_produccion');
    }
};
