...
-- Sistema de Novedades de Recibos con Auditoría (Sin Trigger)
-- =============================================
...
CREATE TABLE `prendas_pedido_novedades_recibo` (
    ...
    -- Índices de rendimiento (nombres diferentes a los únicos)
    ...
    KEY `idx_editado_flag` (`editado`),
    KEY `idx_editado_fecha` (`editado_en`),
...
-- =============================================
-- NOTA: El trigger se manejará desde la aplicación Laravel
-- =============================================

-- El trigger automático para auditoría se manejará desde el backend de Laravel
-- en lugar de usar triggers de MySQL para evitar problemas de permisos SUPER.
-- La lógica de auditoría está implementada en el controlador RecibosNovedadesController.php
