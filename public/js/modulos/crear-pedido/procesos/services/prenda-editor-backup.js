...
class PrendaEditor {
    ...
    cargarVariaciones(prenda) {
        ...
        if (!mangaOpcion && variantes.tipo_manga_id) {
            console.warn('[cargarVariaciones]  tipo_manga_id sin nombre - esto no debería pasar', variantes.tipo_manga_id);
        ...
        if (!brocheOpcion && variantes.tipo_broche_id) {
            console.warn('[cargarVariaciones]  tipo_broche_id sin nombre - esto no debería pasar', variantes.tipo_broche_id);
            // No hacer nada, dejar vacío para que el usuario llene
        }
