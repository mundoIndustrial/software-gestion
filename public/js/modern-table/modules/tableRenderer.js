        ...
        updateTableWithData: (orders, totalDiasCalculados, areaOptions = [], context = 'registros', userRole = null) => {
            ...
            orders.forEach(orden => {
                ...
                if (context === 'registros') {
                    ...
                    // Botones Editar, Ver, Borrar, Generar Script SQL
                    botonesHTML = `
                        ...
                        <button class="action-btn sql-btn" onclick="generarScriptSQL(${pedidoKey})" title="Generar script SQL" style="background-color: #8b5cf6; color: white; border: 1px solid #8b5cf6; padding: 5px 10px; border-radius: 15px; cursor: pointer; font-size: 11px; font-weight: 600; flex: 0 0 auto; height: 36px; text-align: center; display: flex; align-items: center; justify-content: center; white-space: nowrap; transition: all 0.2s ease;"><i class="fas fa-database" style="margin-right: 4px;"></i> SQL</button>
