...
@section('page-title', 'Todas las Cotizaciones')
...
@section('content')
    ...
    @include('components.cotizaciones.header', [
        ...
        'subtitle' => 'Visualiza todas las cotizaciones de todos los asesores',
        'searchUrl' => route('supervisor-asesores.cotizaciones.index'),
        'actionButton' => [
        ...
        <div id="seccion-todas" class="seccion-tipo" style="display: block;">
            @include('components.cotizaciones.table', [
                ...
                'columns' => [
                    ...
                    ['key' => 'asesor', 'label' => 'Asesor', 'filterable' => true, 'align' => 'left'],
...
<!-- Configurar URL de filtros para supervisor -->
<script>
    // Redefine la URL del endpoint para obtener valores de filtro (supervisor)
    window.FILTER_VALUES_URL = '/supervisor-asesores/cotizaciones/filtros/valores';
</script>
