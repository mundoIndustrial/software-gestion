...
<script>
    ...
    function cargarComponentes(prendaId) {
        ...
        const url = '{{ route("contador.componentes") }}';
    ...
    function cargarCostos(prendaId) {
        fetch('{{ route("contador.costos", ":prendaId") }}'.replace(':prendaId', prendaId))
    ...
    function agregarCosto(prendaId) {
        ...
        if (componenteNombre && !componenteId) {
            fetch('{{ route("contador.componente.crear") }}', {
                method: 'POST',
                headers: {
    ...
    function guardarCosto(prendaId, componenteId, costo) {
        fetch('{{ route("contador.costo.guardar") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
    ...
    function eliminarCosto(costoId, prendaId) {
        if (confirm('¿Estás seguro de que deseas eliminar este costo?')) {
            fetch('{{ route("contador.costo.eliminar", ":costoId") }}'.replace(':costoId', costoId), {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
                }
    ...
    function filtrarComponentes(prendaId) {
        ...
        fetch('{{ route("contador.componentes") }}')
            .then(response => {
    ...
    function guardarFormatoCotizacion(cotizacionId) {
        fetch('{{ route("contador.formato.guardar") }}', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
    ...
    function cargarFormatos() {
        fetch('{{ route("contador.formatos.index") }}')
            .then(response => response.json())
            .then(formatos => {
    ...
    function verFormatoDetalle(formatoId) {
        fetch('{{ route("contador.formato.show", ":id") }}'.replace(':id', formatoId))
            .then(response => response.json())
            .then(formato => {
                const modal = document.createElement('div');
    ...
    function eliminarFormato(formatoId) {
        if (confirm('¿Estás seguro de que deseas eliminar este formato?')) {
            fetch('{{ route("contador.formato.destroy", ":id") }}'.replace(':id', formatoId), {
                method: 'DELETE',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content
                }
