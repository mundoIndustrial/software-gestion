                ...
                @foreach($rows as $row)
                    <tr>
                        ...
                        <td>
                            ...
                            @endphp
                            @php
                                $totalPrendas = array_sum($prendasAgrupadas);
                                if ($totalPrendas > 0 && !empty($prendas) && isset($prendas[0]->nombre_prenda)) {
                                    $nombrePrenda = $prendas[0]->nombre_prenda;
                                    echo '<strong>' . $totalPrendas . ' ' . $nombrePrenda . '</strong>';
                                } else {
