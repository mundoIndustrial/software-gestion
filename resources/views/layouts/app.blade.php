...
@push('scripts')
    ...
    @elseif(request()->is('recibos-costura') || request()->is('recibos-bodega') || request()->is('recibos-bordado-estampado') || request()->is('recibos-reflectivo'))
        <script>
            ...
            function clearRecibosSearch() {
                if (!window.location.pathname.includes('recibos-costura') && !window.location.pathname.includes('recibos-bodega') && !window.location.pathname.includes('recibos-bordado-estampado') && !window.location.pathname.includes('recibos-reflectivo')) {
                    return;
                }
