...
<div class="tableros-container">
    <div style="max-width: 900px; width: 70%; margin: 0 auto;">
        ...
        <div class="modern-modal-container" style="margin: 0;">
            <form action="{{ route('balanceo.prenda.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-content">
                    <div class="section-card">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="nombre" required value="{{ old('nombre') }}" class="form-input" placeholder="Ej: Camisa Polo Básica">
                                @error('nombre')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="referencia" value="{{ old('referencia') }}" class="form-input" placeholder="Ej: REF-001">
                                @error('referencia')
                                <p style="color: #f5576c; font-size: 13px; margin-top: 4px;">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="form-group" style="grid-column: 1 / -1;">
                                ...
                                <textarea name="descripcion" rows="4" class="form-input" style="resize: vertical;" placeholder="Descripción detallada de la prenda...">{{ old('descripcion') }}</textarea>
                                @error('descripcion')
                                <p style="color: #f5576c; font-size: 13px; margin-top: 4px;">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="form-actions">
                        <a href="{{ route('balanceo.index') }}" class="btn btn-secondary">
