            ...
            <div class="producto-section">
                ...
                <div class="section-content">
                    <div style="margin-bottom: 1rem;">
                        ...
                        <label style="display: block; min-height: 50px; padding: 0.4rem; border: 2px dashed #0066cc; border-radius: 6px; cursor: pointer; text-align: center; background: #f0f7ff;" ondrop="event.preventDefault(); if(event.dataTransfer.files) this.querySelector('input').files = event.dataTransfer.files; try { limpiarDropzoneVisual(this); } catch (_) {} this.querySelector('input').onchange && this.querySelector('input').onchange();" ondragover="try { manejarDragOver(event, this); } catch (_) { event.preventDefault(); this.style.background='#e8f4f8'; }" ondragleave="try { manejarDragLeave(event, this); } catch (_) { this.style.background='#f0f7ff'; }">
                    ...
                    <div class="form-col full">
                        ...
                        <table style="width: 100%; border-collapse: collapse; background: white; margin: 0; border: 1px solid #ddd; border-radius: 4px; overflow: hidden; display: none;" class="variaciones-tabla-desktop">
                            ...
                            <tbody>
                                ...
                                <tr style="border-bottom: 1px solid #eee; background-color: white;">
                                    ...
                                    <td style="padding: 14px 12px;">
                                        <input type="text" name="productos_prenda[][variantes][obs_reflectivo]" placeholder="Ej: Reflectivo en pecho y espalda..." style="width: 100%; padding: 8px 12px; border: 1px solid #ddd; border-radius: 4px; font-size: 0.9rem; box-sizing: border-box; transition: border-color 0.2s;">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div style="display: none;" class="variaciones-cards-mobile">
                            ...
                            <div style="background: white; border: 1px solid #ddd; border-radius: 6px; padding: 12px; margin-bottom: 12px;">
                                <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 10px;">
                                    <input type="checkbox" name="productos_prenda[][variantes][aplica_reflectivo]" value="1" style="width: 18px; height: 18px; cursor: pointer; accent-color: #0066cc;">
                                    <label style="font-weight: 600; color: #0066cc; cursor: pointer; flex: 1;"><i class="fas fa-lightbulb"></i> Reflectivo</label>
                                </div>
                                <input type="text" name="productos_prenda[][variantes][obs_reflectivo]" placeholder="Ej: Reflectivo en pecho y espalda..." style="width: 100%; padding: 8px 12px; border: 1px solid #ddd; border-radius: 4px; font-size: 0.9rem; box-sizing: border-box; transition: border-color 0.2s;">
                            </div>
                        </div>
