            ...
            <form id="form-proceso-generico">
                ...
                <div class="form-section">
                    <label class="form-label-primary">
                        <span class="material-symbols-rounded">photo_camera</span>IMÁGENES (Opcional)
                    </label>
                    
                    <div class="foto-panel" style="display: flex; gap: 1rem;">
                        <!-- Vista previa de imagen -->
                        <div id="proceso-foto-preview" class="foto-preview-lg" onclick="document.getElementById('proceso-foto-input').click()" style="width: 150px; height: 150px; border: 2px dashed #0066cc; border-radius: 8px; display: flex; align-items: center; justify-content: center; cursor: pointer; background: #f9fafb;">
                            <div style="text-align: center;">
                                <div class="material-symbols-rounded" style="font-size: 2rem;">add_photo_alternate</div>
                                <div style="font-size: 0.75rem; color: #6b7280; margin-top: 0.5rem;">Click para agregar</div>
                            </div>
                        </div>
                        
                        <!-- Info de imágenes -->
                        <div style="flex: 1;">
                            <input type="file" id="proceso-foto-input" accept="image/*" style="display: none;" onchange="manejarImagenesProceso(this)">
                            <div id="proceso-foto-contador" style="margin-bottom: 1rem;"></div>
                            <button type="button" id="proceso-foto-btn" class="btn btn-sm btn-primary" onclick="document.getElementById('proceso-foto-input').click()" style="display: none;">
                                + Agregar más fotos
                            </button>
                        </div>
                    </div>
