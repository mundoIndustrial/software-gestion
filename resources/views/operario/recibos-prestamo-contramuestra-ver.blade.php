...
@section('page-title')
    <span style="display: inline-flex; align-items: center; gap: 0.6rem;">
        ...
        <span>VER RECIBO CONTRAMUESTRA</span>
    </span>
@endsection
...
@section('content')
    ...
    <div class="prestamo-shell">
        <div class="prestamo-top">
            <a class="btn-soft" href="{{ route('operario.recibos-prestamo.index', ['tab' => 'contramuestra']) }}">Volver</a>
        </div>
            ...
            <div class="order-detail-card" style="display:block;">
                ...
                <div class="order-descripcion">
                    <div>
                        ...
                        <span style="display:block;margin-top:8px;margin-bottom:12px;color:#212529;font-weight:600;">Préstamo de Contramuestra Costura</span>
                        ...
                        <span style="display:block;margin-top:8px;margin-bottom:12px;color:#212529;font-weight:600;white-space:pre-wrap;">{{ $recibo->descripcion }}</span>
                    </div>
                </div>

                <h2 class="receipt-title">RECIBO DE PRÉSTAMO<br>CONTRAMUESTRA COSTURA</h2>
