...
Route::middleware(['auth', 'supervisor-readonly'])->group(function () {
    ...
    Route::get('/api/recibos-bordado-estampado/areas-disponibles', [RegistroOrdenController::class, 'obtenerAreasDisponiblesPorTipo'])->name('api.recibos-bordado-estampado.areas-disponibles');
    ...
    Route::post('/api/recibo-corte-bodega/resolver-base', [ReciboCorteBodegaController::class, 'resolverBase'])->name('api.recibo-corte-bodega.resolver-base');
