...
echo "=== CREAR COLUMNA descripcion_armada Y LLENARLA ===\n\n";

try {
    // 1. Crear columna
    echo "1️⃣  Creando columna 'descripcion_armada'...\n";
    DB::statement("
        ALTER TABLE prendas_pedido 
        ADD COLUMN descripcion_armada LONGTEXT NULL AFTER descripcion
    ");
    echo "✅ Columna creada\n\n";
    
    // 2. Llenar la columna con datos armados
    echo "2️⃣  Llenando descripcion_armada...\n";
    ...
    foreach ($prendas as $prenda) {
        ...
        if ($prenda->cantidad_talla) {
            // cantidad_talla es JSON, intentar extraer info
    ...
    echo "  ✅ Totales actualizados: $actualizado\n\n";
    
    // 3. Verificar algunos ejemplos
    echo "3️⃣  Ejemplos de descripciones armadas:\n\n";
    ...
    foreach ($ejemplos as $ej) {
        echo "ID: {$ej->id}\n";
        echo "Original: " . substr($ej->descripcion, 0, 60) . "...\n";
        echo "Armada:   " . substr($ej->descripcion_armada, 0, 80) . "...\n";
        echo "---\n";
    }
    
    echo "\n✅ ¡LISTO! Ahora puedes filtrar contra 'descripcion_armada'\n";
